...
Da alle im Rahmen dieser Arbeit definierten Metriken und Kennzahlen auf konkrete Ziele des Bildungsportals evaschiffmann.de ausgerichtet sind, wird im weiteren Verlauf der Begriff "KPI" stellvertretend für alle verwendet. Dies dient in erster Linie der Lesbarkeit und verdeutlicht ebenfalls, dass übergeordnete Ziel, die Interaktionen der Nutzer mit dem Bildungsportal möglichst umfassend darzustellen.
...
- Andere Wissenschaftliche Arbeiten betrachten: Weshalb wurden für die Nutzeranalyse auf einem bestimmten Bildungsportal diese Metriken ausgewählt 
- Daraus abgeleitet sollen die Metriken für das Bildungsportal evaschiffmann.de definiert und begründet werden
- Nun möchte ich eine Tabelle einbinden, in welcher alle Kennzahlen, Metriken und KPIs definiert werden, welche verwendet werden sollen
- Außerdem möchte ich noch erklären (eventuell auch in einer Übersicht, z.B. Tabelle oder noch als Spalte in der bereits erstellten Tabelle) wie die Datenerfassung der jeweiligen Kennzahl, Metrik oder KPI erfolgt 
