...
Zusätzlich zu den KPIs aus Tabelle~\ref{tab:kpi_allgemein} dienen die in Tabelle B1 im Anhang dargestellten Indikatoren dazu, eine Übersicht über das Verhalten und die Interaktionen der Nutzer mit der gesamten Website zu erfassen.

Für die Webseite \textit{https://evaschiffmann.de/zum-tagebuch} sind die Indikatoren aus Tabelle B2 relevant.

Für die Webseite \textit{https://evaschiffmann.de/wer-war-eva-schiffmann} sind die Indikatoren aus Tabelle B3 relevant. 

Für die Webseite \textit{https://evaschiffmann.de/themen} sind die Indikatoren aus Tabelle B4 relevant.

Für die Webseite \textit{http://evaschiffmann.de/orte} sind die Indikatoren aus Tabelle B5 relevant.

Für die Webseite \textit{http://evaschiffmann.de/evas-lektueren} sind die Indikatoren aus Tabelle B6 relevant.
